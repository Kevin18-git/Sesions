...
public class ProcesarDatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProcesarDatos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Resgistro Procesado</h1>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (nombre == null || nombre.isBlank()|| apellido==null||apellido.isBlank()){
                out.println("<h1>todos los campos deben estar completados</h1>");
            }else{
                out.println("<h1>registro procesado</h1>");
                out.print("<p>nombre: " + nombre +"</p>");
                out.print("<p>Apellido: "+apellido+"</p>");
